...
/**
 * Takes array of tweets and find lowest id.
 * 
 * @param {Array} tweets - get array of tweets
 * @returns {number} - lowest id from list of all tweets
 */
...
/**
 * Fetch tweets and save in Tweets.json file.
 * 
 * @param {string} searchQuery - Combination of all provided keywords, filters and different option parameters
 * @param {string} token - Bearer Token
 * @param {number} pages - Number of pages
 */
const getData = async (searchQuery, token, pages, file_path) => {
  const final_data = [];
